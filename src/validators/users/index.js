...
const {AuthenticationPostPayloadSchema, AuthenticationPutPayloadSchema, AuthenticationDeletePayloadSchema} = require('./schema');
...
const AuthenticationValidator = {
    ...
    validateAuthenticationPuttPayload: (payload) => {
